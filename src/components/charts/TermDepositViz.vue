                 ...
                 <div class="row">
                    <div class="col-sm p-2 mb-2 bg-dark">
                                <div class="card">
                                    ...
                                    <p class="title" style="color:black;"><i class="fas fa-university"></i> {{summary['accountType']}}</p>
                                    <p class="card-subtitle" style="color:black;"><b>Current Value</b>:{{summary['currentValue']}}</p>
                                    <p class="card-text" style="color:black;"><b>Principal Value</b>:{{summary['principalAmount']}}</p>
                                    <p class="card-subtitle" style="color:black;"><b>Opening Date: </b>{{summary['openingDate']}}</p>
...
export default {
  ...
  setup(props) {
    ...
    const profile = ref([]);
    const type = ref(null);
    console.log("terMDepositData", depositData);
    // Transactions
